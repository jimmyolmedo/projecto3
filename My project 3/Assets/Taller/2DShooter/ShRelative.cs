...
{
    public class ShRelative : MonoBehaviour
    {
        ...
        public void SpawnBullet(float angle, Vector2 bulletDirection)
        {
            ...
            newObject.transform.position = bulletSpawn.transform.position;
            ...
            if (rigidbody2D != null)
            {
                Vector3 realDirection = lastShootPosition - bulletSpawn.position;
        ...
        public void DrawPresition()
        {
            ...
            Gizmos.DrawLine(bulletSpawn.transform.position, transform.position + (Vector3)(directionAlpha * 10));
            Gizmos.DrawLine(bulletSpawn.position, transform.position + (Vector3)(directionAlphaSpread * 10));
            Gizmos.DrawLine(bulletSpawn.position, transform.position + (Vector3)(directionAlphaSpread2 * 10));

            // Last Shoot
            if (thereIsLastShoot == false) return;
            Gizmos.color = Color.red;
            Gizmos.DrawLine(bulletSpawn.transform.position, lastShootPosition);
